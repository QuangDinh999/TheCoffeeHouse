...
@section('content')
    <form method="post" action="">
        ...
        <fieldset>
            ...
            <label>Name: </label><br>
            <input type="text" name="cus_name" placeholder="Name..." value="{{$customer->cus_name}}" style="border:solid #337ab7 2px; margin-bottom: 15px; ; padding: 5px; width: 40%"><br>
            <label>Email: </label><br>
            <input type="email" name="cus_email" placeholder="Email..." value="{{$customer->cus_email}}" style="border:solid #337ab7 2px; margin-bottom: 15px; ; padding: 5px; width: 40%"><br>
